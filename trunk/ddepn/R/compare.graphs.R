...
compare.graphs.tc <- function(O,M) {
	...
	##     in dem originalgraphen auch wirklich nicht da, dann ist das als TN zu z�hlen
	...
	## graphen soi lassen wie sie sind und nur echte, direkte verbindungen z�hlen
...
#
#
### z�hle echte/falsche aktiv/passiv stati
